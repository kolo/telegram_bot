...
func (c *Client) get(method string, p requestParams, value interface{}) error {
	...
	return send(func() (*http.Response, error) {
		return c.httpClient.Get(requestUrl.String())
	}, value)
}
...
func (c *Client) post(method string, p requestParams, value interface{}) error {
	...
	return send(func() (*http.Response, error) {
		return c.httpClient.PostForm(c.requestBaseUrl(method), data)
	}, value)
}
...
func send(doRequest func() (*http.Response, error), value interface{}) error {
	resp, err := doRequest()
	if err != nil {
		return err
	}
